...
type IconProps = AntIconProps & IconFontProps;

const Icon: React.FC<IconProps> = (props) => {
  const { type } = props;
  const isLocalIcon = type in LocalIcon;
  return isLocalIcon ? <AntIcon { ...props as AntIconProps}/> : <IconFont { ...props as IconFontProps }/>;
}
